/* Quemia C. A. de Oliveira*/

CREATE DATABASE revgas;
USE revgas;

CREATE TABLE bancos(
	cod_compensacao integer PRIMARY KEY NOT NULL,
    nome_instituicao varchar(256) NOT NULL
    ); 

INSERT INTO bancos VALUES (1, "Banco do Brasil S. A."),
...
SELECT * FROM revgas.bancos;

--  Listar Banco Específico pelo código de parâmentro

SELECT * FROM revgas.bancos
where cod_compensacao = "1"; 
